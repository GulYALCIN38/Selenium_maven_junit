 ...
 */
    ...
    protected ExtentTest extentTest;// test asamalari icin bilgi ekler
    ...
    public void setUp() {
        ...
        extentReports.setSystemInfo("Testeuse","Gul");
        extentHtmlReporter.config().setDocumentTitle("Extent Report");
        extentHtmlReporter.config().setDocumentTitle("Resulta de Test");
        extentTest=extentReports.createTest("Extent Tests","Rapport de Test");
...
//        path
    ...
    // SCROLLINTOVIEWJS bir elementin ustune gel
...
//    Bu method ile sayfanin en altina inebiliriz
    ...
    //belirli bir elemente jsexecuter ile tikla
    public void clickAvecJS(WebElement element){
        JavascriptExecutor js = (JavascriptExecutor)driver;
        js.executeScript("arguments[0].click();",element);
    }
    // elemente metin yazdir
    //sendkeys methoduna alternatiftir
    public void typeAvecJS(WebElement element,String metin){
        JavascriptExecutor js = (JavascriptExecutor)driver;
        js.executeScript("arguments[0].setAttribute('value','"+metin+"')",element);
    }
    //input elementindeki degerleri alir
    //    input elementindeki degerleri(value) al
       ...
       //    .toString();
           ...
           public void getValuesAvecJS(String idOfElement){//get.text ile  alamayacagim inputtaki elemani value yi  verir
               JavascriptExecutor js = (JavascriptExecutor)driver;
